                        ...
                        <div class="row g-1">
                         ...
                         <div class="d-grid  p-1 col-md-auto col-sm-12 order-3 btn-responsive">
                            <?php if (chk_para(session("user_info")["ui_para"],$menu_active."_add")=="ok" or session("user_info")["ui_type"]=="1"){ ?>
                              <a class="btn btn-primary btn-responsive" data-bs-toggle="modal" data-remote="{{ route('location.create') }}"  data-bs-target="#modal-add"><i class="fas fa-plus"></i>
                          ...
                          <?php } ?>
                            ...
                            <div class="d-grid p-1 col-md-auto col-sm-12 order-2 btn-responsive">
                                <form action="{{ route('location.list') }}" method="GET">
                                    <div class="input-group">
                                        <span class="input-group-text" id="addon-wrapping"><i class="fas fa-search"></i></span>
                                        <input name="q" type="text" class="form-control" placeholder="جزء من المدينة أو اسم الفرع">
                            ...
                            <div class="d-grid p-1 col-md-auto col-sm-12 order-1 btn-responsive">
                                <?php if (chk_para(session("user_info")["ui_para"],$menu_active."_rep")=="ok" or session("user_info")["ui_type"]=="1"){ ?>
                                    <a class="btn btn-success btn-responsive" data-bs-toggle="modal" data-remote="{{ route('location.rep') }}"  data-bs-target="#modal-rep"><i class="far fa-file-alt"></i> <b>التقارير</b></a>
                                  <?php } ?>
                                  </div>
                                ...
                                <table class="table app-table-hover mb-0 table-striped table-bordered text-center" data-toggle="table" id="datat_list">
                                    <thead>
                                        <tr class="bg-infox">
                                            ...
                                            <th class="text-center" data-visible="true">اسم الفرع</th>
                                            <th class="text-center" data-visible="true">المدينة</th>
                                    ...
                                    <tbody>
                                        @unless ($listings->isEmpty())
                                            @foreach ($listings as $location)
                                                <tr>
                                                    <td class="cell">
                                                        <a class="btn btn-success" data-bs-toggle="modal" data-remote="{{ route('location.show', enc($location->id)) }}" data-bs-target="#modal-show">
                                                            <i class="fas fa-file-alt"></i>
                                                        </a>
                                                    </td>
                                                    <td class="cell">{{ $location->branch_name }}</td>
                                                    <td class="cell">{{ $location->city }}</td>
                                                    <td class="cell">{{ $location->id }}</td>
                                                </tr>
                                            @endforeach
                                        @endunless
                                    </tbody>
